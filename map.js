...
function initializeMap() { 
  ...
  document.getElementById("bar").onclick = function(){turnToBars()};
  
  function turnToBars(){
    types="boardgames cafe";
  }
  
  
  document.getElementById("res").onclick = function(){turnToRestaurants()};
  
  function turnToRestaurants(){
    types="boardgames";
  }
